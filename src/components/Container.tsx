...
export default function Container({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="bg-custom">
      ...
      <Sidebar />
      <div className={`container-full h-screen px-10 relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden ${isSidebarOpen ? 'lg:ml-96' : ''}`} style={{ transition: 'margin-left 300ms ease' }}>
