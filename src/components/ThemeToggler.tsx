...
const ThemeToggle = () => {
    ...
    return (
        <div className="flex items-center">
            ...
            >
                <span
                    className={`transform transition ease-in-out duration-200 inline-block w-4 h-4 bg-slate-100 dark:bg-slate-300 rounded-full ${darkMode ? 'translate-x-5' : 'translate-x-1'}`}
                />
            </button>
        </div>
    );
